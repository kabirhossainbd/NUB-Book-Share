...
class _EasyDateTimeLineState extends State<EasyDateTimeLine> {
  ...
  void initState() {
    ...
    super.initState();
    // Get initial month
    _easyMonth = EasyDateUtils.convertDateToEasyMonth(widget.initialDate, widget.locale);
        ...
        children: [
          if (_headerProps.showHeader)
            Padding(
              ...
              child: Row(
                mainAxisAlignment: _headerProps.centerHeader == true ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween,
                children: [
                  if (_showMonthPicker(pickerType: MonthPickerType.dropDown))
                    child!,
                  if (_showMonthPicker(pickerType: MonthPickerType.switcher))
                    Expanded(
                      child: EasyMonthSwitcher(
