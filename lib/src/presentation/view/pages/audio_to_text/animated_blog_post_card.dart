                  ...
                  Expanded(
                    child: RichText(
                      text: TextSpan(
                        ...
                        style: textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.bold, color: MyColor.getTextColor()),
                        children: [
                          TextSpan(
                            text: ' created a new post',
                            style: textTheme.bodyLarge!.copyWith(color: MyColor.getSecondaryColor()),
                          ),
