...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    Get.find<BookController>().getAllBooks();
          ...
          body: DefaultTabController(
            ...
            child: Scaffold(
                ...
                body: RefreshIndicator(
                  onRefresh: ()async{
                    await  Get.find<BookController>().getAllBooks();
                  },
                            ...
                            Column(
                             children: [
                               ...
                               _customTitleRow("Continue reading", onTap: (){
                                 //Navigator.push(context, PageTransition(child: const MyBookScreen(), type: PageTransitionType.rightToLeft));
                               }),
                               const SizedBox(height: 8),
                             ],
                           ),
